...
```
En ambos casos nos da como resultado 7.0. Sin embargo el tipo de dato al que pertenecen es distinto. En el primer ejemplo el resultado es de tipo `long double` y en el segundo el resultado es de tipo `double`. La regla general es que el tipo de dato del resultado será el tipo de dato mas "amplio" o "preciso" (en el sentido de la cantidad de memoria que usan) de los operandos involucrados en la operación. Esta idea viene resumida en la siguiente tabla: 
